  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center ${collapsed ? "justify-center px-0 py-6" : "justify-between px-6 py-6"}`}>
        ...
        >
          <img src="/logo-brain.png" alt="Matoteka" className="h-12 w-12 flex-shrink-0" />
          {!collapsed && (
            <div>
              <h2 className="text-2xl font-semibold tracking-tight text-heading whitespace-nowrap" style={{ fontFamily: "var(--font-fredoka), sans-serif" }}>
                Matoteka
              </h2>
